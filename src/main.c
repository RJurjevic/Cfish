...
/*
  ...
  V 15.0
    ...
    - Used nn-bc8b85a47e63.nnue NNUE aka nn-v0f000020010.nnue as the run 20010 epoch 16990 / 16.99B trend-supported selected-bucket candidate net trained with the June 9 trainer using quiescence_threshold 200.
