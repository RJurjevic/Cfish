...
attrib -R cfish_v15.1_*.exe >nul 2>&1
powershell -NoProfile -Command "Get-Item cfish_v15.1_*_win.exe -ErrorAction SilentlyContinue | Unblock-File" >nul 2>&1

for %%F in (
  cfish_v15.1_x86-64-vnni_win.exe
  cfish_v15.1_x86-64-avx512_win.exe
  cfish_v15.1_x86-64-avx2_win.exe
  cfish_v15.1_x86-64-sse41_win.exe
) do (
  if exist "%%F" (
    echo Patching %%F
